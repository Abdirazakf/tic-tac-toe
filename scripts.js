...
const Round = (() => {
    ...
    const slot1Logic = () => {
        if ((gameboard.moveCounter % 2 == 1) && board[0] !== "O" && !gameOver){
            board[0] = "X"
            gameboard.moveCounter++
            elements.slot1.textContent = "X"
        } else if ((gameboard.moveCounter % 2 == 0) && board[0] !== "X" && !gameOver){
            board[0] = "O"
            gameboard.moveCounter++
    ...
    const slot2Logic = () => {
        if ((gameboard.moveCounter % 2 == 1 ) && board[1] !== "O" && !gameOver){
            board[1] = "X"
            gameboard.moveCounter++
            elements.slot2.textContent = "X"
        } else if ((gameboard.moveCounter % 2 == 0) && board[1] !== "X" && !gameOver){
            board[1] = "O"
            gameboard.moveCounter++
    ...
    const slot3Logic = () => {
        if ((gameboard.moveCounter % 2 == 1 ) && board[2] !== "O" && !gameOver){
            board[2] = "X"
            gameboard.moveCounter++
            elements.slot3.textContent = "X"
        } else if ((gameboard.moveCounter % 2 == 0) && board[2] !== "X" && !gameOver){
            board[2] = "O"
            gameboard.moveCounter++
    ...
    const slot4Logic = () => {
        if ((gameboard.moveCounter % 2 == 1 ) && board[3] !== "O" && !gameOver){
            board[3] = "X"
            gameboard.moveCounter++
            elements.slot4.textContent = "X"
        } else if ((gameboard.moveCounter % 2 == 0) && board[3] !== "X" && !gameOver){
            board[3] = "O"
            gameboard.moveCounter++
    ...
    const slot5Logic = () => {
        if ((gameboard.moveCounter % 2 == 1 ) && board[4] !== "O" && !gameOver){
            board[4] = "X"
            gameboard.moveCounter++
            elements.slot5.textContent = "X"
        } else if ((gameboard.moveCounter % 2 == 0) && board[4] !== "X" && !gameOver){
            board[4] = "O"
            gameboard.moveCounter++
    ...
    const slot6Logic = () => {
        if ((gameboard.moveCounter % 2 == 1 ) && board[5] !== "O" && !gameOver){
            board[5] = "X"
            gameboard.moveCounter++
            elements.slot6.textContent = "X"
        } else if ((gameboard.moveCounter % 2 == 0) && board[5] !== "X" && !gameOver){
            board[5] = "O"
            gameboard.moveCounter++
    ...
    const slot7Logic = () => {
        if ((gameboard.moveCounter % 2 == 1 ) && board[6] !== "O" && !gameOver){
            board[6] = "X"
            gameboard.moveCounter++
            elements.slot7.textContent = "X"
        } else if ((gameboard.moveCounter % 2 == 0) && board[6] !== "X" && !gameOver){
            board[6] = "O"
            gameboard.moveCounter++
    ...
    const slot8Logic = () => {
        if ((gameboard.moveCounter % 2 == 1 ) && board[7] !== "O" && !gameOver){
            board[7] = "X"
            gameboard.moveCounter++
            elements.slot8.textContent = "X"
        } else if ((gameboard.moveCounter % 2 == 0) && board[7] !== "X" && !gameOver){
            board[7] = "O"
            gameboard.moveCounter++
    ...
    const slot9Logic = () => {
        if ((gameboard.moveCounter % 2 == 1 ) && board[8] !== "O" && !gameOver){
            board[8] = "X"
            gameboard.moveCounter++
            elements.slot9.textContent = "X"
        } else if ((gameboard.moveCounter % 2 == 0) && board[8] !== "X" && !gameOver){
            board[8] = "O"
            gameboard.moveCounter++
